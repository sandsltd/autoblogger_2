...
Generate ONE specific, timely topic title (50-80 characters). Focus on current relevance and local impact.`;
  ...
  try {
    ...
    const fallbacks = [
      `Why ${locationName} businesses need mobile-first websites in ${year}`,
      `${season} digital marketing opportunities for Somerset companies`,
      `Website security threats facing ${locationName} businesses this ${month}`,
      `How AI is changing web design for ${locationName} SMEs`,
      `GDPR updates ${year}: What ${locationName} websites must know`
    ];
...
- Start 20% of sentences with And/But/So
- Use contractions throughout (don't, won't, we're, it's)
- Add personal touches: "We've found that...", "Just last week..."
- Include rhetorical questions
- Vary paragraph lengths (1-5 sentences)
- Add parenthetical asides (like this)
- Use specific numbers: £2,347 not £2,000, 73% not 70%
- Include informal transitions: "Here's the thing..."
- Mix short punchy sentences. With longer, more complex ones that explore ideas in greater depth
- Reference current month/season specifically
- Add unexpected comparisons or analogies
- Occasionally end sentences with prepositions
